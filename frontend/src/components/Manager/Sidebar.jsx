...
import { 
    FaThLarge, FaUsers, FaChartLine, FaCalendarCheck, 
...
const HrSidebar = () => {
    ...
    const menuItems = [
        { name: 'Dashboard', icon: <FaThLarge />, path: '/Managerdashboard' },
        { name: 'Employees', icon: <FaUsers />, path: '/employees' },
        { name: 'Performance', icon: <FaChartLine />, path: '/employeeperformance' },
            ...
            <div className="px-6 py-8 border-b border-slate-50 flex items-center gap-3.5">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-1.5 mt-1.5">
                        ...
                        <p className="text-[9px] text-slate-400 font-bold uppercase tracking-[0.2em]">HR Manager</p>
                    </div>
                </div>
            </div>
